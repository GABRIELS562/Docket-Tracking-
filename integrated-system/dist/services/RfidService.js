...
class RfidService {
    ...
    async initialize() {
        ...
        if (this.simulationMode) {
            ...
            logger_1.logger.info('RFID simulation mode started');
        }
    }
    ...
    async processEventBatch(batchSize) {
        ...
        `);
            ...
            logger_1.logger.debug(`Processed ${batch.length} RFID events`);
        }
        catch (error) {
            logger_1.logger.error('Failed to process RFID event batch:', error);
