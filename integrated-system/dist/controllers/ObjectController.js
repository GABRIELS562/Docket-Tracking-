...
class ObjectController {
    ...
    async getObject(req, res) {
      ...
      `, [id]);
            ...
            logger_1.logger.error('Error getting object:', error);
    ...
    async createObject(req, res) {
      ...
      `, [result.rows[0].id, userId, JSON.stringify(result.rows[0])]);
            ...
            logger_1.logger.error('Error creating object:', error);
    ...
    async updateObject(req, res) {
      ...
      `, [id, userId, JSON.stringify(currentResult.rows[0]), JSON.stringify(result.rows[0])]);
            ...
            logger_1.logger.error('Error updating object:', error);
    ...
    async deleteObject(req, res) {
      ...
      `, [id, userId]);
            ...
            logger_1.logger.error('Error deleting object:', error);
    ...
    async searchObjects(req, res) {
      ...
      `;
            ...
            logger_1.logger.error('Error searching objects:', error);
    ...
    async assignObject(req, res) {
        ...
        `, [id, userId, notes]);
            ...
            logger_1.logger.error('Error assigning object:', error);
    ...
    async moveObject(req, res) {
        ...
        `, [id, userId, current.rows[0].current_location_id, location_id, notes]);
            ...
            logger_1.logger.error('Error moving object:', error);
    ...
    async tagObject(req, res) {
      ...
      `, [tags, id]);
            ...
            logger_1.logger.error('Error tagging object:', error);
    ...
    async getObjectHistory(req, res) {
      ...
      `, [id]);
            ...
            logger_1.logger.error('Error getting object history:', error);
    ...
    async getChainOfCustody(req, res) {
      ...
      `, [id]);
            ...
            logger_1.logger.error('Error getting chain of custody:', error);
    ...
    async getObjectTypes(_req, res) {
      ...
      `);
            ...
            logger_1.logger.error('Error getting object types:', error);
    ...
    async getObjectStats(_req, res) {
      ...
      `);
            ...
            logger_1.logger.error('Error getting object stats:', error);
